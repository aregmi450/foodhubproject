...
$sql=mysqli_query($con,"update  products set venueName='$venuename',productPrice='$productprice',productDescription='$productdescription',,productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
$query=mysqli_query($con,"select products.*,category.categoryName as catname from products join category on category.id=products.category where products.id='$pid'");
$cnt=1;
...
<div class="controls">
<input type="text"    name="venueName"  placeholder="Enter Product Name" value="<?php echo htmlentities($row['venueName']);?>" class="span8 tip" >
</div>
</div>
