...
if(isset($_POST['submit']))
{
	...
	// $venuecompany=$_POST['venueCompany'];
	$productprice=$_POST['productprice'];
	$productpricebd=$_POST['productpricebd'];
	$productdescription=$_POST['productDescription'];
	// $transportationFare=$_POST['transportationFare'];
...
$sql=mysqli_query($con,"insert into products(category,venueName,productPrice,productDescription,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount) values('$category','$venuename','$productprice','$productdescription',''$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<div class="controls">
<input type="text"    name="venueName"  placeholder="Enter Product Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="venueCompany"  placeholder="Enter Product Comapny Name" class="span8 tip" required>
</div>
</div> -->
<div class="control-group">
...
<div class="controls">
<input type="text"    name="transportationFare"  placeholder="Enter Product Shipping Charge" class="span8 tip" required>
</div>
</div> -->
