...
$query=mysqli_query($con,"select venueName,productImage2 from products where id='$pid'");
$cnt=1;
...
<div class="controls">
<input type="text"    name="venueName"  readonly value="<?php echo htmlentities($row['venueName']);?>" class="span8 tip" required>
</div>
</div>
