				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<h3 class="name"><a href="index.php?page-detail"><?php echo $row['venueName']; ?></a></h3>
							<div class="price">Rs.<?php echo ($row['productPrice']+$row['transportationFare']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
