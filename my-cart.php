					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input type="submit" name="submit" value="Delete shopping cart" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
 ...
 $pdtid=array();
    $sql = "SELECT * FROM products WHERE id IN(";
			...
			while($row = mysqli_fetch_array($query)){
				...
				$subtotal= $_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['transportationFare'];
				$totalprice += $subtotal;
	...
	?>
				...
				<tr>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="product-details.php?pid=<?php echo htmlentities($pd=$row['id']);?>" ><?php echo $row['venueName'];
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rs"." ".$row['transportationFare']; ?>.00</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['transportationFare']); ?>.00</span></td>
				</tr>
