...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.venueName as pname,products.id as proid,orders.productId as opid,orders.quantity as qty,products.productPrice as pprice,products.transportationFare as transportationFare,orders.paymentMethod as paym,orders.orderDate as odate,orders.id as orderid from orders join products on orders.productId=products.id where orders.userId='".$_SESSION['id']."' and orders.paymentMethod is not null");
$cnt=1;
...
?>
				<tr>
					...
					<td class="cart-product-sub-total"><?php echo $shippcharge=$row['transportationFare']; ?>  </td>
