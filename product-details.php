...
echo "<script>alert('Product aaded in Favourite');</script>";
...
<?php
$ret=mysqli_query($con,"select category.categoryName as catname,subCategory.subcategory as subcatname,products.venueName as pname from products join category on category.id=products.category join subcategory on subcategory.id=products.subCategory where products.id='$pid'");
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['venueName']);?>" href="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>">
                ...
                <div class="item">
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name"><?php echo htmlentities($row['venueName']);?></h1>
...
<!-- <div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php echo htmlentities($row['venueCompany']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							<!-- </div>  -->
...
<!-- <div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Transportation Fare:</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php if($row['transportationFare']==0)
											{
												echo "Free";
											}
											else
											{
												echo htmlentities($row['transportationFare']);
											}
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Favourite" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
